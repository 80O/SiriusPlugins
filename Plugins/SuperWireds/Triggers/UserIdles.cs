...
public class UserIdlesInteractionBuilder : IFurnitureInteractionBuilder
{
    public void AttachBehaviors(IRoom room, FloorFurniObject furniObject)
    {
        furniObject.ActionBehavior = new UserIdlesTrigger(room, furniObject);
        furniObject.ClickBehavior = new WiredClickBehavior(furniObject);
    }

    public string InteractionKey => "wf_trg_user_idles";
}

public class UserIdlesTrigger : WiredTriggerBehavior
{
    public UserIdlesTrigger(IRoom room, FloorFurniObject wiredItem) : base(room, wiredItem)
    {
